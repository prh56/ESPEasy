...
*  SDM_V2 - added more SDM630 Registers - Andreas Mueller
*/
...
#define SDM630_KWH_TOTAL                    0x0156                              //kWh
#define SDM630_VOLTAGE_THD_AVERAGE          0x00F8                              //Percent
#define SDM630_CURRENT_THD_AVERAGE          0x00FA                              //Percent
#define SDM630_LINE_TO_LINE_VOLTS_AVERAGE   0x00CE                              //V
...
#if !defined ( USE_HARDWARESERIAL )
  ESPeasySoftwareSerial sdmSer = ESPeasySoftwareSerial(_rx_pin, _tx_pin, false, 32);
#else
